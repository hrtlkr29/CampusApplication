...
public class RobotEventDetailActivity extends AppCompatActivity implements View.OnClickListener {
...
//        isJoined = false;
    ...
    protected void onStart() {
        super.onStart();
        DatabaseReference participantsRef = db.child("sport").child("robot").child("event").child(eventId).child("participants");
    ...
    private void goToMessages() {
        Intent intent = new Intent(RobotEventDetailActivity.this, MessageActivity.class);
