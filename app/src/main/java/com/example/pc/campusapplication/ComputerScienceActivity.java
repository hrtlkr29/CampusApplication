...
public class ComputerScienceActivity extends AppCompatActivity implements View.OnClickListener,ViewPager.OnPageChangeListener {
    ViewPager viewPager;
    ComputerSciencePagerAdapter CSPagerAdapter;
...
//        btnAttendance.setOnClickListener(this);
        ...
        CSPagerAdapter = new ComputerSciencePagerAdapter(getSupportFragmentManager());
