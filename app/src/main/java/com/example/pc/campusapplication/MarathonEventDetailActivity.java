...
public class MarathonEventDetailActivity extends AppCompatActivity implements View.OnClickListener {
...
//        isJoined = false;
    ...
    protected void onStart() {
        super.onStart();
        DatabaseReference participantsRef = db.child("sport").child("Marathon").child("event").child(eventId).child("participants");
    ...
    private void goToParticipants(){
        Intent intent = new Intent(MarathonEventDetailActivity.this, MarathonEventParticipantActivity.class);
        intent.putExtra("eventID", this.eventId);
        startActivity(intent);
    }
