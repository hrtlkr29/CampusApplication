...
public class RobotActivity extends AppCompatActivity implements View.OnClickListener,ViewPager.OnPageChangeListener {
    ViewPager viewPager;
    RobotPagerAdapter SPPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SPPagerAdapter = new RobotPagerAdapter(getSupportFragmentManager());
